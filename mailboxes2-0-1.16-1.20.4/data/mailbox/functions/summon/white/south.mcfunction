...
execute run summon armor_stand ~ ~-0.5 ~-.3 {Invisible:1,NoGravity:1,Invulnerable:1b,ArmorItems:[{},{},{},{id:white_terracotta,Count:1b}], Tags:[mailbox], DisabledSlots:2096896, Marker:1b, Fire:100}
execute run summon armor_stand ~ ~-0.5 ~.1 {Invisible:1,NoGravity:1,Invulnerable:1b,ArmorItems:[{},{},{},{id:white_terracotta,Count:1b}], Tags:[mailbox], DisabledSlots:2096896, Marker:1b, Fire:100}
